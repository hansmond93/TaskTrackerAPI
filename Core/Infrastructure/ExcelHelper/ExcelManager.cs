...
namespace ExcelManager
{
    public class ExcelReader
    {
        ...
        /// <returns></returns>
        public IEnumerable<T> ReadWorkBookSheets<T>(
            int sheetIndex, bool includeHeaders = false,
            Func<List<ICell>, string, object> predicate = null,
        ...
        private List<T> ReadExcelSheet<T>(
            List<ISheet> _readableSheets,
